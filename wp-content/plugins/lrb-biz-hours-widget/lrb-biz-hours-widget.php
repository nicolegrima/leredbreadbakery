 ...
 * Description:       A handy business hours for the Le Red Bread Bakery.
 * Version:           1.0.0
 * Author:            Nicole Grima
...
class LRB_Hours extends WP_Widget {
    ...
    /**
     * @TODO - Rename "lrb_hours" to the name your your widget
     *
	...
	public function update( $new_instance, $old_instance ) {
		...
		// taking old widget data and over riding with new data
